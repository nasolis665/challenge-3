...
lowText = text.lower()
rnd1 = input("Enter random letters: ")
rnd2 = input("Enter random letters: ")
rnd3 = input("Enter random letters: ")
print(lowText.count(rnd1))
print(lowText.count(rnd2))
print(lowText.count(rnd3))
